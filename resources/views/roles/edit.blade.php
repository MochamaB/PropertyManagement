         ...
         <div class="col-auto col-md-10 ">
             <nav aria-label="breadcrumb " class="first d-md-flex">
                 <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5 ">
                     ...
                     <li class="breadcrumb-item font-weight-bold mr-0 pr-0"><a class="black-text active-1" href="#" style="text-decoration: none !important;"><span style="color:blue">Edit Roles</span></a> </li>
                 </ol>
             </nav>
         </div>
     </div>
                        ...
                        <form method="POST" action="{{ route('roles.update', $role->id) }}">
                            ...
                            <div class="col-md-6 form-group mb-3">
                                ...
                                <input value="{{ $role->name }}" 
                                    ...
                                    name="name" 
                                    placeholder="Edit Name of Role" required>
