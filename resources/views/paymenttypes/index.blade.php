         ...
         <div class="col-auto col-md-10 ">
             <nav aria-label="breadcrumb " class="first d-md-flex">
                 <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5 ">
                     ...
                     <li class="breadcrumb-item font-weight-bold mr-0 pr-0"><a class="black-text active-1" href="#" style="text-decoration: none !important;"><span style="color:blue">View All Payment Types</span></a> </li>
                 </ol>
             </nav>
         </div>
     </div>
...
<!---------  breadcrumbs ---------------->
                ...
                @endif
                <br />
                       <button class="btn btn-primary btn-lg text-white mb-0 me-0" style="float:right" type="button" onclick="window.location='{{ url("/add-paymenttype") }}'">
                         <i class="mdi mdi mdi-file-document"></i>Create New Payment Type</button>
                       <br />
                    <h4>List of All Payment Types</h4>
                     ...
                     <table id="table"
                        ...
                        <tbody style="padding-left:0; padding-right:0px">
                            ...
                            <tr>
                                ...
                                <td>{{ $item->code }}</td>
                                <td>{{ $item->provider }}</td>
                                <td><a href="{{ url('edit-paymenttype/'.$item->id) }}" class="btn btn-primary btn-sm"><i class="mdi mdi-lead-pencil"></i></a>
                                <a href="" class="btn btn-danger btn-sm"><i class="mdi mdi-delete"></i></a></td>
                            </tr>
                             @endforeach
                        </tbody>
                    </table>
