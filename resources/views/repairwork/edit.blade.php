                ...
                <div class="card-body">
                        ...
                        <div class="col-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="dateofrepair" value="{{'JID-'.$repairwork->dateofrepair}}" class="form-control" />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="amountpaid" class="form-control" value="{{$repairwork->amountpaid}}" placeholder="" />
                        ...
                        <div class="col-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="amountspent" value="" class="form-control" value="{{$repairwork->amountspent}}" />
                                    ...
                                    @endif
                                        ...
                                        <select  class="form-control" style="color:black"value="{{$repairwork->status}}" name="status" >
                                        ...
                                        <select  class="form-control" style="color:black" name="assignedto" value="{{$repairwork->assignedto}}">
