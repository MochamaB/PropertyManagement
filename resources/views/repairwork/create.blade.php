                    ...
                    <div class="row">
                        <div class="col-6">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="date" name="dateofrepair" value="" class="form-control" />
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="amountspent" value="" class="form-control" />
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="amountpaid" class="form-control" placeholder="" />
                                    ...
                                    @endif
                                        ...
                                        <textarea name="suppliesused" class="form-control" placeholder="Name of product/tool and amount"></textarea>
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                        <label for="">Description of work done</label>
                                        <textarea name="descworkdone" class="form-control" placeholder="Give details of actual work done"></textarea>
                                        </div>  
                                        <div class="form-group col-md-6 mb-3">
                                        <label for="">Recommendations</label>
                                        <textarea name="recommendations" class="form-control" placeholder="Type Some Text.." ></textarea>
                                        </div>
                                        <div class="form-group col-md-6 mb-3">
                                        <label for="">Status <span style="color:red;font-size:20px">*</span></label>
                                        <select  class="form-control" style="color:black" name="status" required>
                                        ...
                                        <select  class="form-control" style="color:black" name="assignedto">
