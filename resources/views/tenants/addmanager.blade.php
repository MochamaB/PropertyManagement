...
<!---------  breadcrumbs ---------------->
         ...
         <div class="col-auto col-md-10 ">
             <nav aria-label="breadcrumb " class="first d-md-flex">
                 <ol class="breadcrumb indigo lighten-6 first-1 shadow-lg mb-5 ">
                     ...
                     <li class="breadcrumb-item font-weight-bold mr-0 pr-0"><a class="black-text active-1" href="#" style="text-decoration: none !important;"><span style="color:blue">Add Tenant Managers</span></a> </li>
                 </ol>
             </nav>
         </div>
     </div>
     ...
     @if (session('status'))
        ...
        <div class="col-md-5">
            <div class="card">
                <div class="card-header">
                    ...
                    <h4>Add Managers To Tenant</h4>
                </div>
                <div class="card-body">
                <form action="{{ url('store-tenantmanagers/'.$tenants->id) }}" method="POST">
                                @method('post')
                                @csrf
                        ...
                        @if( Auth::user()->can('Tenants.store_managers'))
        ...
        <div class="col-md-7">
            <div class="card">
                <div class="card-header">
                <a href="{{ url('tenants') }}" class="btn btn-danger float-end">Back to Tenants</a><br/>
                    <h4> Remove Managers of Tenant</h4>
                </div>
                <div class="card-body">
                <div class=" table-responsive">
                <form action="{{ url('update-tenantmanagers/'.$tenants->id) }}" method="POST">
        @method('put')
        @csrf 
                    <table id="table"
